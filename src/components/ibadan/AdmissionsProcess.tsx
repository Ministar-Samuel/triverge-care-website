...
export function AdmissionsProcess() {
    return (
        <section className="py-[120px] px-[20px] md:px-[40px] bg-gradient-to-b from-porcelain to-[#e0f7fa] relative z-10 shadow-2xl rounded-b-[60px]">
            ...
            <div className="max-w-[1200px] mx-auto text-center">
                ...
                <div className="mb-[60px]">
                    ...
                    <p className="text-xl font-body text-charcoal/80">
                    ...
                    {STEPS.map((step, idx) => (
                        <div key={idx} className="relative group perspective-1000">
                            <motion.div
                                ...
                                className="bg-white p-[30px] rounded-[24px] shadow-sm hover:shadow-xl transition-shadow duration-300 flex flex-col items-center"
                            >
                                <div className="w-[60px] h-[60px] rounded-full bg-triverge-blue/5 flex items-center justify-center mb-4 text-healing-teal text-3xl group-hover:bg-healing-teal group-hover:text-white transition-colors duration-300">
                                    <Icon icon={step.icon} />
                                </div>
                                <div className="w-8 h-8 rounded-full bg-triverge-blue text-white flex items-center justify-center font-bold text-sm mb-4">
                                    {idx + 1}
                                </div>
                                <h3 className="text-lg font-bold font-heading text-triverge-blue mb-2">{step.title}</h3>
                ...
                {/* Pulse Contact Box */}
                <motion.div
                    className="inline-flex items-center gap-[40px] bg-triverge-blue text-white p-[10px] pr-[40px] rounded-full shadow-2xl shadow-healing-teal/20 animate-pulse-slow max-w-full overflow-hidden"
