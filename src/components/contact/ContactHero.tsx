...
export function ContactHero() {
    return (
        <div className="pt-[120px] pb-[100px] px-[20px] md:px-[40px] bg-white">
            <div className="max-w-[1440px] mx-auto flex flex-col gap-[100px]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-[60px] items-center">
                    ...
                    >
                        <div>
                            <h1 className="text-4xl md:text-5xl font-bold font-heading text-triverge-blue mb-4">
                                Talk to Us
                            </h1>
                            <p className="text-xl font-body text-charcoal/80 font-light leading-relaxed">
                        ...
                        <div className="flex flex-col gap-8">
                            {CONTACT_INFO.map((item, idx) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <p className="text-lg font-medium font-heading text-charcoal group-hover:text-triverge-blue transition-colors">
                                            {item.text}
                                        </p>
                                        {item.sub && (
                                            <p className="text-lg font-medium font-heading text-charcoal/60 group-hover:text-triverge-blue transition-colors">
                                                {item.sub}
                                            </p>
                                        )}
                                    </div>
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.8 }}
                        className="w-full h-[400px] md:h-[500px] rounded-[32px] overflow-hidden shadow-2xl relative border-8 border-white"
                    >
                        <iframe
                            ...
                            className="grayscale contrast-110 invert-[0.05] transition-all"
                        ></iframe>
                    </motion.div>
                </div>
                ...
                >
                    <div className="bg-[#f9f9f9] border border-gray-100 rounded-[40px] p-[40px] md:p-[60px] shadow-2xl relative overflow-hidden">
                        {/* Decorative Background Icon */}
                        <div className="absolute -top-10 -right-10 opacity-5 pointer-events-none">
                            <Icon icon="solar:phone-calling-bold-duotone" className="text-[200px] text-triverge-blue" />
                        </div>

                        <h3 className="text-3xl md:text-4xl font-bold font-heading text-triverge-blue mb-10 text-center">Request a Call Back</h3>

                        <form className="flex flex-col gap-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="flex flex-col gap-3">
                                    <label className="text-xs font-black text-charcoal/40 uppercase tracking-[0.2em]">Full Name</label>
                                    <input
                                        type="text"
                                        className="bg-transparent border-b-2 border-triverge-blue/10 py-3 text-xl text-triverge-blue focus:outline-none focus:border-healing-teal transition-colors placeholder:text-gray-300 font-heading"
                                        placeholder="Dr. Jane Doe"
                                    />
                                </div>
                                <div className="flex flex-col gap-3">
                                    <label className="text-xs font-black text-charcoal/40 uppercase tracking-[0.2em]">Phone Number</label>
                                    <input
                                        type="tel"
                                        className="bg-transparent border-b-2 border-triverge-blue/10 py-3 text-xl text-triverge-blue focus:outline-none focus:border-healing-teal transition-colors placeholder:text-gray-300 font-heading"
                                        placeholder="+234..."
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="flex flex-col gap-3">
                                    <label className="text-xs font-black text-charcoal/40 uppercase tracking-[0.2em]">Preferred Time</label>
                                    <div className="relative">
                                        <select className="w-full bg-transparent border-b-2 border-triverge-blue/10 py-3 text-xl text-triverge-blue focus:outline-none focus:border-healing-teal transition-colors cursor-pointer appearance-none font-heading">
                                ...
                                <div className="flex flex-col gap-3">
                                    <label className="text-xs font-black text-charcoal/40 uppercase tracking-[0.2em]">Service Interest</label>
                                    <div className="relative">
                                        <select className="w-full bg-transparent border-b-2 border-triverge-blue/10 py-3 text-xl text-triverge-blue focus:outline-none focus:border-healing-teal transition-colors cursor-pointer appearance-none font-heading">
                            ...
                            <div className="flex flex-col gap-3">
                                <label className="text-xs font-black text-charcoal/40 uppercase tracking-[0.2em]">How can we help?</label>
                                <textarea
                                    rows={4}
                                    className="bg-transparent border-b-2 border-triverge-blue/10 py-3 text-xl text-triverge-blue focus:outline-none focus:border-healing-teal transition-colors resize-none placeholder:text-gray-300 font-heading"
