        ...
        <main className="min-h-screen bg-porcelain">
            ...
            <div className="max-w-[1200px] mx-auto px-[20px] md:px-[40px] py-[100px] grid grid-cols-1 lg:grid-cols-12 gap-[60px]">
                ...
                <div className="lg:col-span-7 flex flex-col gap-10">
                    <div>
                        <h2 className="text-3xl font-bold font-heading text-triverge-blue mb-6">About this Service</h2>
                    ...
                    <div>
                        <h3 className="text-xl font-bold font-heading text-triverge-blue mb-6">Key Features</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {service.features.map((feature, i) => (
                                <div key={i} className="flex items-center gap-3 p-4 bg-white rounded-xl border border-gray-100">
                                    ...
                                    <span className="font-heading font-medium text-charcoal">{feature}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="lg:col-span-5 flex flex-col gap-6">
                    <div className="bg-white p-[40px] rounded-[32px] shadow-lg border border-gray-100 sticky top-[100px]">
                        <h3 className="text-2xl font-bold font-heading text-triverge-blue mb-8">Why Choose Us?</h3>
                        ...
                        <div className="flex flex-col gap-8">
                            {service.benefits.map((benefit, i) => (
                                <div key={i} className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold font-heading text-triverge-blue text-lg mb-1">{benefit.title}</h4>
                                        <p className="text-sm font-body text-charcoal/60 leading-relaxed">{benefit.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
            ...
            <div className="py-[100px] bg-white">
                <div className="max-w-[1200px] mx-auto px-[20px] md:px-[40px] mb-12">
                    <h2 className="text-3xl font-bold font-heading text-center text-triverge-blue">Other Services</h2>
                </div>
