...
const STATS = [
    { label: "Total Bookings", value: "124", icon: "solar:calendar-bold-duotone", color: "text-blue-600", bg: "bg-blue-50" },
    { label: "HCAP Students", value: "45", icon: "solar:diploma-bold-duotone", color: "text-purple-600", bg: "bg-purple-50" },
    { label: "Subscribers", value: "892", icon: "solar:letter-bold-duotone", color: "text-orange-600", bg: "bg-orange-50" },
    { label: "Revenue (Mo)", value: "₦4.2M", icon: "solar:wallet-money-bold-duotone", color: "text-green-600", bg: "bg-green-50" },
];
                ...
                {STATS.map((stat) => (
                    <div key={stat.label} className="bg-white p-6 rounded-[24px] border border-gray-100 flex items-center gap-4 shadow-sm">
                        ...
                        <div>
                            ...
                            <p className="text-2xl font-bold font-heading text-charcoal mt-1">{stat.value}</p>
                        </div>
                    </div>
                ))}
            </div>
                        ...
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="flex items-center gap-4 p-3 hover:bg-gray-50 rounded-xl transition-colors">
                                ...
                                <div className="flex-1">
                                    <p className="text-sm font-bold text-charcoal">New Booking Request</p>
                                    <p className="text-xs text-charcoal/50">Mrs. Adebayo scheduled a consultation.</p>
                                </div>
